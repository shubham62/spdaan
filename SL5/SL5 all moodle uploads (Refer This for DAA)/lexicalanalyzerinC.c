...
Output -
 ...
 UST....
id = 0    	name = void 			type = KEY
id = 1    	name = read(){ 			type = IDN
id = 2    	name = int 			type = KEY
id = 3    	name = a,b,c; 			type = IDN
id = 4    	name = a 			type = IDN
id = 5    	name = = 			type = OPR
id = 6    	name = 10; 			type = IDN
id = 7    	name = b=20; 			type = IDN
id = 8    	name = c 			type = IDN
id = 9    	name = = 			type = OPR
id = 10    	name = a+b; 			type = IDN

 IDT....
id = 0    	name = read(){ 			type = var
id = 1    	name = a,b,c; 			type = var
id = 2    	name = a 			type = var
id = 3    	name = 10; 			type = var
id = 4    	name = b=20; 			type = var
id = 5    	name = c 			type = var
